...
- Removed the dependency on the `fivetran/twitter_organic_source` package.
  ...
  - Update any twitter_organic_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_twitter_organic/blob/main/README.md) for how to configure the build schema of staging models.
